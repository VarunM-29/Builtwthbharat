...
import { handleSentinelRequest } from './handlers/sentinel';
...
// Sentinel Link - Pay $0.005 USDC
app.post('/sentinel/analyze', handleSentinelRequest);
...
/**
 * Free Sentinel analysis endpoint - allows testing the prototype
 * without the x402 payment requirements.
 */
app.post('/api/free/sentinel/analyze', handleSentinelRequest);
